...
//getting the total items
	...
	if($count_cats==0){
		...
		echo "<h1 style='padding:20px;'><b style='color:red;'>No product in this Catagory!</b></h2>";
	}
	...
	if($count_brands==0){
		...
		echo "<h1 style='padding:20px;'><b style='color:red;'>No product in this Brand!</b></h2>";
	}
