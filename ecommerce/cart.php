...
<html>
	<head>
		<title>This is Binary House</title>
	...
	<div class="content_wrapper"> 
		...
		<div id="content_area">
			...
			<b style="color:yellow">Shopping Cart -</b>Total Items: <?php total_items();?> Total Price: <?php total_price(); ?> <a href="index.php" style="color:blue;">Back to Shop</a>
			...
			<?php $ip = GetIP();?>
			<div id="products_boxcart">
				<form action="" method="post" enctype="maltipart/form-data">
					<table align="center" width="700" bgcolor="#7FFF00">
						<tr align="center">
							<td colspan="3"><h2>Update Your Cart Or Checkout!</h2></td>
						</tr>
						...
						<tr align="center">
							...
							<img src="admin_area/product_images/<?php echo $product_image;?>" width="50" height="50"/></td>
						...
						<tr align="center">
							...
							<td><a href="checkout.php">CHECK</a></td>
						</tr>
					</table>
